...
function toggleNumberOfPayments() {
  ...
  var numberOfPayments = document.getElementById('number-of-payments-container');
  var numberOfPaymentsInput = document.getElementById('number-of-payments-container');
...
document.getElementById('checkbox').addEventListener('change', toggleNumberOfPayments);
